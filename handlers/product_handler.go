...
func (h *CategoryHandler) GetCategoryAll(w http.ResponseWriter, r *http.Request) {
	categories, err := h.service.GetCategoryAll()
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
// Update - UPDATE /api/categories/{id}
